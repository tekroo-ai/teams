...
OUTPUT = TEAMS / "OUTPUT/phase-3/sma-q1n-step15-v3-rerun1"
ORIGINAL_V3_OUTPUT = TEAMS / "OUTPUT/phase-3/sma-q1n-step15-v3"
...
def preflight(journal: DurableJournal) -> dict[str, Any]:
    ...
    checks = {
        ...
        "corrective_rerun": {
            "authorized_by": "frozen v3 rerunPolicy",
            "classification": "DOCUMENTED_HARNESS_SETUP_AND_RECEIPT_DEFECT",
            "original_harness": "scripts/smaq1_native_step15_v3_attempt1.py",
            "original_harness_sha256": "59ea7d1b3bc5562993e801a361620c1a748be8423f78c579e486b27270e5fef7",
            "original_journal": str(ORIGINAL_V3_OUTPUT / "raw-receipts.jsonl"),
            "original_journal_sha256": "250200bb95e8a4d7ab0b0f7e0fe1645b65e2370234dacd4fef5582db10318811",
            "defects": [
                "qualification workspaces lacked the repository .openhands hook symlink",
                "final receipt referenced qualification_result before assignment",
            ],
