...
PACKAGE = ROOT / "investigations/sma-q1/layered/sma-e1-ddalcu-candidate-3-package-identity.json"
...
OUTPUT = ROOT / "OUTPUT/phase-3/sma-e1-ddalcu-candidate-3-live-state-preflight/preflight.json"
EXPECTED_PACKAGE = "449665cb18ae5d168cf84e855545eb4a4fef3963ba274460c92cde236653b88e"
EXPECTED_EXECUTION = "e0aed2cbdc8b162d55ca34237c914ce8c77291eb3b9a06e98715e2eadbce3222"
EXPECTED_PACKAGE_ACCEPTANCE_SHA = "042a8df4c4bcbf984c9985ca2feeffd22d1bff4fc1399807939eec3236e5551c"
EXPECTED_IDENTITY_ACCEPTANCE_SHA = "8ca2a0ea897c46c4d78f38eea84d8cc86a086d198c2dbbf9951be7cf3581291b"
...
def main() -> int:
    if OUTPUT.exists():
        raise RuntimeError("candidate-3 single-use preflight receipt already exists")
    checks: list[dict] = []
    observations: dict = {}
    ...
    try:
        ...
        assert_check(checks, "package_acceptance_bound", sha(PACKAGE_ACCEPTANCE) == subject["packageAcceptanceRecordSha256"], sha(PACKAGE_ACCEPTANCE))
    ...
    receipt = {
        "schemaVersion": "1.0.0",
        "recordType": "SMA_E1_DDALCU_CANDIDATE_3_READ_ONLY_LIVE_STATE_PREFLIGHT",
        "recordedAt": recorded,
