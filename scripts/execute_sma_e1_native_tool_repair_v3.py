...
DIAGNOSTIC_OUTPUT = ROOT / "OUTPUT/phase-3/sma-e1-ddalcu-native-tool-repair-v3-case16-diagnostic"
CANARY_OUTPUT = ROOT / "OUTPUT/phase-3/sma-e1-ddalcu-native-tool-repair-v3-all-scenario-canary"
...
def compose(repo, mode, authority, definition_path):
    ...
    if (
        ...
        raise RuntimeError("v3 live acceptance compatibility record mismatch")
    compatible = replace(
        authority,
