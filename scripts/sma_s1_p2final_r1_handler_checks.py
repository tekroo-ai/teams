...
RUN_ID = "sma-s1-handler-check-p2final-r1-candidate-1"
NAMESPACES = {
    "mongodbDatabase": "sma_s1_handler_p2final_r1_candidate_1",
    "semanticCollection": "sma_s1_handler_semantic_p2final_r1_candidate_1",
    "episodicCollection": "sma_s1_handler_episodic_p2final_r1_candidate_1",
    "actorAlphaPartition": "sma-s1-handler-alpha-p2final-r1-candidate-1",
    "actorBetaPartition": "sma-s1-handler-beta-p2final-r1-candidate-1",
