...
def main() -> int:
    ...
    run_id = "sma-s1-handler-implementation-check-p2m-evidence-v2-candidate-2"
    namespaces = {
        "mongodbDatabase": "sma_s1_driver_fixture_handler_p2m_evidence_v2_candidate_2",
        "semanticCollection": "sma_s1_driver_fixture_handler_semantic_p2m_evidence_v2_candidate_2",
        "episodicCollection": "sma_s1_driver_fixture_handler_episodic_p2m_evidence_v2_candidate_2",
        "actorAlphaPartition": "sma-s1-fixture-actor-alpha-handler-p2m-evidence-v2-candidate-2",
        "actorBetaPartition": "sma-s1-fixture-actor-beta-handler-p2m-evidence-v2-candidate-2",
