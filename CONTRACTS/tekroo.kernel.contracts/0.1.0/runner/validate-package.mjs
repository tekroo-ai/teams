...
check("contract-identity", manifest.contract.name === "tekroo.kernel.contracts" && manifest.contract.version === "0.1.0");
...
const compatibility = readJson("compatibility/no-predecessor.json");
check("initial-compatibility-record", compatibility.predecessor === null && compatibility.contractVersion === "0.1.0");
