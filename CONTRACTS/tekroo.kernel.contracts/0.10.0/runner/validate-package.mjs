...
check("contract-identity", manifest.contract.name === "tekroo.kernel.contracts" && manifest.contract.version === "0.10.0");
...
const compatibility = readJson("compatibility/from-0.9.0.json");
check("successor-compatibility-record", compatibility.predecessor?.contractVersion === "0.9.0" && compatibility.contractVersion === "0.10.0" && compatibility.compatibility === "ADDITIVE");
