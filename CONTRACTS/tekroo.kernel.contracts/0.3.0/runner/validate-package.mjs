...
check("contract-identity", manifest.contract.name === "tekroo.kernel.contracts" && manifest.contract.version === "0.3.0");
...
const compatibility = readJson("compatibility/from-0.2.0.json");
check("successor-compatibility-record", compatibility.predecessor?.contractVersion === "0.2.0" && compatibility.contractVersion === "0.3.0" && compatibility.directions?.adapter === "REQUIRED");
