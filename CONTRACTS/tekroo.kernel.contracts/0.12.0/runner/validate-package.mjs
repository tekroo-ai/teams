...
check("contract-identity", manifest.contract.name === "tekroo.kernel.contracts" && manifest.contract.version === "0.12.0");
...
check("decision-trace-count", decisions.length === 63, decisions.length);
...
const compatibility = readJson("compatibility/from-0.11.0.json");
check("successor-compatibility-record", compatibility.predecessor?.contractVersion === "0.11.0" && compatibility.contractVersion === "0.12.0" && compatibility.compatibility === "ADDITIVE");
