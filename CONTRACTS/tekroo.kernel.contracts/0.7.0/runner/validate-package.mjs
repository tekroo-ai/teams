...
check("contract-identity", manifest.contract.name === "tekroo.kernel.contracts" && manifest.contract.version === "0.7.0");
...
check("decision-trace-count", decisions.length === 38, decisions.length);
...
const compatibility = readJson("compatibility/from-0.6.0.json");
check("successor-compatibility-record", compatibility.predecessor?.contractVersion === "0.6.0" && compatibility.contractVersion === "0.7.0" && compatibility.directions?.adapter === "REQUIRED");
