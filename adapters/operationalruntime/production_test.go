...
func writeProductionFixture(t *testing.T) (string, ProductionConfig) {
	...
	config := ProductionConfig{
		...
		TeamsDatabaseIdentity: "tekroo_v4", SMADatabaseIdentity: "sma_v4", AuthorizationPolicyFile: "authorization.json", ProvenanceFile: "provenance.json", EvidenceRoot: "evidence",
